...
if (isset($_GET["id"]) && !empty(trim($_GET["id"]))) {
	...
	$department = new Department($param_id);
	$department->destroy();
	echo "<script>alert('Departamento eliminado con éxito.'); window.location.href='departments.php';</script>";
} else {
	echo "Error: No se ha encontrado el id del departamento";
}
