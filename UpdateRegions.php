...
<body>
    ...
    <div id="content">
        ...
        ?>
        <div id="section">
            <h2>Modificar Región</h2>
            <form action="EjecutarUpdateRegions.php" method="POST">
                <label for="region_id">Region ID:</label>
                <input type="text" name="region_id" id="region_id" value="<?php echo htmlspecialchars($param_id); ?>" readonly required><br><br>

                <label for="region_name">Nombre región:</label>
                <input type="text" name="region_name" id="region_name" required maxlength="25"><br><br>

                <input type="submit" value="Modificar Región">
            </form>
        </div>
    </div>
