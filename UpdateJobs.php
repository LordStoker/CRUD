...
<body>
    ...
    <div id="content">
        ...
        <div id="section">
            <h2>Modificar Job</h2>
            <form action="EjecutarUpdateJobs.php" method="POST">
                <label for="job_id">Job ID:</label>
                <input type="text" name="job_id" id="job_id" value="<?php echo htmlspecialchars($param_id); ?>" readonly required><br><br>

                <label for="job_title">Nombre Job:</label>
                <input type="text" name="job_title" id="job_title" value="<?php echo ($job_title); ?>" readonly required><br><br>

                <label for="min_salary">Min Salary:</label>
                <input type="number" name="min_salary" id="min_salary" ><br><br>

                <label for="max_salary">Max Salary:</label>
                <input type="number" name="max_salary" id="max_salary" ><br><br>

                <input type="submit" value="Modificar Job">
            </form>
        </div>
    </div>
