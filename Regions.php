	...
	<div id="content">
		...
		<div id="section">
			...
			"<thead>" .
				...
				"<th>#</th>"          .
				"<th>Region Name</th>"  .
				"<th>Actions " . '<a href="InsertRegion.php' . '" class="mr-2" title="New File " data-toggle="tooltip"><span class="fa fa-pencil-square-o"></span></a>' .
				"</th>" .
				"</tr>" .
				"</thead>";
			echo "<tbody>";
			foreach ($regions as $region) {
				...
				"<tr>" .
					...
					"<td>" .
					'<a href="UpdateRegions.php?id=' . $region->region_id . '" class="mr-2" title="Update" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>' .
					'<a href="DeleteRegions.php?id=' . $region->region_id . '" class="mr-2" title="Delete" data-toggle="tooltip" onclick="return confirm(\'¿Seguro que quieres eliminar esta región?\');"><span class="fa fa-trash"></span></a>';
				"</td>";
				"</tr>";
			}
			echo "</tbody>";
