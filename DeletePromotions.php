...
if (isset($_GET["id"]) && !empty(trim($_GET["id"]))) {
	...
	$promotion = new Promotion($param_id);
	$promotion->destroy();
	echo "<script>alert('Promoción eliminada con éxito.'); window.location.href='promotions.php';</script>";
} else {
	echo "Error: No se ha encontrado el id de la promoción";
}
?>