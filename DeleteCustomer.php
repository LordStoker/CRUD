...
if (isset($_GET["id"]) && !empty(trim($_GET["id"]))) {
	...
	$customer = new Customer($param_id);
	$customer->destroy();
	echo "<script>alert('Customer eliminado con éxito.'); window.location.href='customers.php';</script>";
} else {
	echo "Error: No se ha encontrado el id del cliente";
}
