...
if (isset($_GET["id"]) && !empty(trim($_GET["id"]))) {
	...
	$location = new Location($param_id);
	$location->destroy();
	echo "<script>alert('Location eliminada con éxito.'); window.location.href='locations.php';</script>";
} else {
	echo "Error: No se ha encontrado el id de la localidad";
}
