...
if (isset($_GET["id"]) && !empty(trim($_GET["id"]))) {
	...
	$employee = new Employee($param_id);
	$employee->destroy();
	echo "<script>alert('Employee eliminado con éxito.'); window.location.href='employees.php';</script>";
} else {
	echo "Error: No se ha encontrado el id del empleado";
}
