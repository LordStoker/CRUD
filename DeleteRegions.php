...
if (isset($_GET["id"]) && !empty(trim($_GET["id"]))) {
	...
	$region = new Region($param_id);
	$region->destroy();
	echo "<script>alert('Región eliminada con éxito.'); window.location.href='regions.php';</script>";
} else {
	echo "Error: No se ha encontrado el id de la región";
}
